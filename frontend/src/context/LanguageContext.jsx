...
export const translations = {
    ...
    step2: { en: 'Land & Crop', ta: 'நிலம் & பயிர்' },
    ...
    rabi: { en: 'Rabi / Samba / Thaladi / Pishanam (Oct–Jan)', ta: 'ரபி / சம்பா / தாளடி / பிசானம் (அக்டோபர்–ஜனவரி)' },
    summerOption: { en: 'Summer / Navarai / Kodai (Feb–May)', ta: 'கோடை / நவரை (பிப்ரவரி–மே)' },
    ...
    primaryIrrigationSource: { en: 'Primary Irrigation Source', ta: 'முக்கிய பாசன நீர் மூலம்' },
    irriRiver: { en: 'River', ta: 'நதி' },
    irrigationMethodUsed: { en: 'Irrigation Method Used', ta: 'பயன்படுத்தப்படும் பாசன முறை' },
    ...
    irriBorewell: { en: 'Borewell', ta: 'ஆழ்துளை கிணறு' },
    irriTubeWell: { en: 'Tube well', ta: 'குழாய் கிணறு' },
    irriCanal: { en: 'Canal', ta: 'கால்வாய்' },
    irriRiverLift: { en: 'River Lift Irrigation', ta: 'ஆற்று நீர் பாசனம்' },
    irriRainfed: { en: 'Rain-fed only (Mazhai nambikkai)', ta: 'மழை ஆதார விவசாயம்' },
    ...
    waterAvailability: { en: 'Water Availability', ta: 'தண்ணீர் வசதி' },
    ...
    waterAvailabilityDetail: { en: 'Water Availability', ta: 'நீர் கிடைக்கும் அளவு' },
